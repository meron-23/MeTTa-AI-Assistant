...
class SyntaxNode:
    ...
    @classmethod
    def new(cls, node_type: SyntaxNodeType, src_range: range, sub_nodes: List["SyntaxNode"]):
        return cls(node_type, src_range, sub_nodes=sub_nodes)

    @classmethod
    def new_token_node(cls, node_type: SyntaxNodeType, src_range: range, text: str):
