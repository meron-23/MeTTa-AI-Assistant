...
class CodeBERTExperiment:
    ...
    def run_experiment(self):
        ...
        # Load data
        try:
            with open('./datas/codebert_code_only.txt', 'r') as f:
        ...
        if code_embeddings is not None:
            np.save('./datas/experiment_code_only.npy', code_embeddings)
        ...
        if combined_embeddings is not None:
            np.save('./datas/experiment_combined.npy', combined_embeddings)
